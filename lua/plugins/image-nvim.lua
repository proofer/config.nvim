...
--     and ensure all its dependencies are installed -- each has a green checkmark
return {
    {
        '3rd/image.nvim',
        config = function()
            require('image').setup({
                ...
                integrations = {
                    markdown = {
                        ...
                        -- Set this to false if you don't want to render images coming from a URL
                        ...
                        only_render_image_at_cursor = false, -- vim.g.neovim_mode == "skitty" and false or true,
