return {
    ...
    event = 'VeryLazy',
    keys = {
        { '<leader>v', '<cmd>PasteImage<CR>', desc = 'Paste image' },
    },
    opts = {
        default = { -- default options commented out
            -- file and directory options
            -- dir_path = "assets", ---@type string | fun(): string
            file_name = function() return vim.fn.expand('%:t:r') .. '-img' end, ---@type string | fun(): string
            -- use_absolute_path = false, ---@type boolean | fun(): boolean
            -- dir_path relative to current file rather than cwd:
